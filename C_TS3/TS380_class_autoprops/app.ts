...
class Transp {
    ...
    constructor(private serialNumber:string) {
        this.speed=0; 
        this.maxSpeed=100;
        // свойство serialNumber автоматически создано с модификатором private
        // и ему присвоено значение аргумента конструктора serialNumber
    }
...
class Car extends Transp {
    ...
    constructor(_serialNumber:string,public carNumber:string) {
        super(_serialNumber); 
        // свойство carNumber автоматически создано с модификатором public
        // и ему присвоено значение аргумента конструктора carNumber
    }

...
// у хэша carHash есть все свойства и методы, которые есть в классе Car
...
// мы НЕ можем присвоить объекту класса Car объект  класса или хэш, не имеющие всех
// свойств и методов класса Car, даже если применим явное преобразование типа
let trainHash={
    speed:100,
};
